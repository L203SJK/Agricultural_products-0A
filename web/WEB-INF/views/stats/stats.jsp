	...
	$.ajax({
		...
		success:function(data){
			if(data.type == 'success'){
				setOption('日销售统计',getKeys(data.sellData),getValues(data.sellData),getRebackValues(getKeys(data.sellData),data.sellRebackData))
			}else{
...
function statsMonth(){
	$.ajax({
		...
		success:function(data){
			if(data.type == 'success'){
				setOption('月销售统计',getKeys(data.sellData),getValues(data.sellData),getRebackValues(getKeys(data.sellData),data.sellRebackData))
			}else{
				$.messager.alert('信息提示',data.msg,'warning');
			}
		}
...
function statsYear(){
	$.ajax({
		...
		success:function(data){
			if(data.type == 'success'){
				setOption('年销售统计',getKeys(data.sellData),getValues(data.sellData),getRebackValues(getKeys(data.sellData),data.sellRebackData))
			}else{
				$.messager.alert('信息提示',data.msg,'warning');
			}
		}
