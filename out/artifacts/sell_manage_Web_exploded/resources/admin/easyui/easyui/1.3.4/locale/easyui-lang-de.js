...
if ($.fn.validatebox){
	$.fn.validatebox.defaults.missingMessage = 'Dieses Feld wird ben枚tigt.';
...
if ($.fn.numberbox){
	$.fn.numberbox.defaults.missingMessage = 'Dieses Feld wird ben枚tigt.';
}
if ($.fn.combobox){
	$.fn.combobox.defaults.missingMessage = 'Dieses Feld wird ben枚tigt.';
}
if ($.fn.combotree){
	$.fn.combotree.defaults.missingMessage = 'Dieses Feld wird ben枚tigt.';
}
if ($.fn.combogrid){
	$.fn.combogrid.defaults.missingMessage = 'Dieses Feld wird ben枚tigt.';
}
if ($.fn.calendar){
...
if ($.fn.datebox){
	...
	$.fn.datebox.defaults.missingMessage = 'Dieses Feld wird ben枚tigt.';
